function IntegralesGui()
    ...
    uilabel(fig, 'Text', 'CALCULADORA DE INTEGRALES', ...
        ...
        'FontColor', 'white', 'BackgroundColor', 'none');
    ...
    panel_opciones = uipanel(fig, 'Title', 'OPCIONES', ...
        ...
        'BackgroundColor', [0.13, 0.13, 0.13], ...
        'ForegroundColor', [0.3, 0.6, 1]);
    opciones = {'Ingresar función manual', 'Mostrar fórmulas de integración'};
    ...
    % Evento cambio en el menú
    dropdown_opciones.ValueChangedFcn = @(src, event) actualizar_campos();
    ...
    function actualizar_campos()
        ...
        if strcmp(opcion, 'Ingresar función manual')
    ...
    function resultado = calcular_integral_definida(func, a, b, metodo)
        switch metodo
            case 'trapecio'
                resultado = (b-a)*(func(a) + func(b))/2;
            case 'simpson'
                resultado = (b-a)/6 * (func(a) + 4*func((a+b)/2) + func(b));
            case 'rectángulos'
                n = 1000;
                h = (b-a)/n;
                x = a:h:(b-h);
                resultado = h * sum(func(x));
            case 'quad'
                resultado = integral(func, a, b);
            otherwise
                resultado = NaN;
        end
    end
